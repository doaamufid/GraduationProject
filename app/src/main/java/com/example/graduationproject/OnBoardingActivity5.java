...
import com.example.graduationproject.databinding.ActivityOnBoarding5Binding;

public class OnBoardingActivity5 extends AppCompatActivity {
    ...
    private ActivityOnBoarding5Binding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityOnBoarding5Binding.inflate(getLayoutInflater());
