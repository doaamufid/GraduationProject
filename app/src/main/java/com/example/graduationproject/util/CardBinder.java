        ...
        if (msg.img != null) {
            ...
            Glide.with(ctx)
                    ...
                    .listener(new RequestListener<>() {
                        @Override
                        public boolean onLoadFailed(@Nullable GlideException e, Object model, @NonNull Target<android.graphics.drawable.Drawable> target, boolean isFirstResource) {
                            imageArea.setVisibility(View.GONE);
                            return false;
                        }

                        @Override
                        public boolean onResourceReady(@NonNull android.graphics.drawable.Drawable resource, @NonNull Object model, Target<android.graphics.drawable.Drawable> target, @NonNull DataSource dataSource, boolean isFirstResource) {
                            return false;
                        }
                    })
                    .into(image);
