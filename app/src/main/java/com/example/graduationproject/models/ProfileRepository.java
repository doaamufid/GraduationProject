...
public final class ProfileRepository {
    ...
    public static List<Badge> badges(Context context) {
        ...
        list.add(new Badge(1, context.getString(R.string.badge_week_label), R.drawable.ic_flame,
                true, context.getColor(R.color.sand), context.getString(R.string.badge_week_need)));
        list.add(new Badge(2, context.getString(R.string.badge_ideas_label), R.drawable.ic_pen_line,
        ...
        list.add(new Badge(4, context.getString(R.string.badge_month_label), R.drawable.ic_calendar,
                false, context.getColor(R.color.sage), context.getString(R.string.badge_month_need)));
        list.add(new Badge(5, context.getString(R.string.badge_message_label), R.drawable.ic_mail,
    ...
    public static List<StatItem> quickStats(Context context) {
        return Arrays.asList(
                ...
                new StatItem(context.getString(R.string.stat_sessions_value), context.getString(R.string.stat_sessions_label))
        );
    }
