...
public class NewChildProfileActivity extends AppCompatActivity {
    ...
    private void setupAgePicker() {
        ...
        for (int i = 3; i <= 12; i++) {
            ...
            binding.ageContainer.addView(tvAge);
        }
    }
    ...
    private void selectGender(String gender) {
        ...
        selectedAvatar = ""; // إعادة تصفير الشخصية المحددة عند تغيير الجنس
    ...
    private void updateStartState() {
        ...
        if (canStart) {
            ...
            binding.tvWorldFox.setText(selectedAvatar); // عرض الشخصية المختارة داخل الكارت
            binding.tvWorldTitle.setText("أهلاً بك يا " + name + " في عالم نور!");
        } else {
            binding.worldCard.setVisibility(View.GONE);
        }
    }
