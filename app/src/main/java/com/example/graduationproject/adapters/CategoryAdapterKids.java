...
public class CategoryAdapterKids extends RecyclerView.Adapter<CategoryAdapterKids.CategoryViewHolder> {
    ...
    public CategoryAdapterKids(List<String> categories, OnCategoryClickListener listener) {
